...
public class Fila {
	 ...
	 * posições, separe os elementos pares e ímpares em dois vetores, e
	 * exiba-os.
	 */
	...
	private static void printList(int[] listNumberOderned, int typeOrdered) {
		if(typeOrdered <= 1)
			System.out.println("Números Pares: " + listNumberOderned);
		else
			System.out.println("Números Impares: " + listNumberOderned);
	}
